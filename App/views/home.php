...
<div class="hero-wrap js-fullheight" style="background-image: url(<?= img($slider->image ?? null) ?>);"
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
            ...
            <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <p class="caps"
                   data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?= $slider->title ?? ''; ?></p>
                <h1 data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?= $slider->text ?? ''; ?></h1>
            </div>
        </div>
    </div>
</div>
